  ...
  return (
    <div className='p-6'>
      <div className='mt-24 h-[80vh] flex'>
        <div className='p-6 w-[35%] border-r border-l'>
          ...
          >
            ...
            <RotatedTotal radius={2} onSelect={setSelected} selected={selected}/>
        ...
        <div className='border-r w-[65%] h-full overflow-y-auto'>
          {selected ? (
            <div className='p-6 flex flex-col gap-6'>
              <img src={selected.pic} alt="" className="w-full rounded" />
              <div>
                <h2 className="mb-2">{selected.name}</h2>
                <h1>{selected.desc}</h1>
              </div>
              <a
                href={selected.link}
            ...
            <div className='p-6 h-full flex items-center justify-center text-center'>
              <p className='text-gray-500'>Click a pin on the globe to see project details</p>
            </div>
          )}
        </div>
      </div>
