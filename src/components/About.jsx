...
export default function About() {
  ...
  return (
    <div className='relative overflow-hidden flex flex-col'>
      <Nav />
      <div className='relative padding lg:mt-24 mt-16 flex-1'>
        <div className="w-full relative flex flex-col lg:flex-row h-full">
          ...
          <div className='order-2 md:order-1 md:w-full border-l border-r border-b'>
            <div id="bio" className='flex md:flex-row flex-col border-b py-12 px-6 gap-4'>

              <div className='flex flex-col justify-between gap-4'>
                <div>
                  <h1>About me</h1>
                  <p className='mt-4 w-[75%] pb-4 border-b'>henry is a product designer, animator, and developer focused on finding ways to combine art with technology in both traditional and modern mediums.</p>
                </div>
              ...
              <img src={aboutpic} className='rounded-xl md:w-[45%] w-[100%] h-full'></img>
            </div>
            ...
            <div className='w-full flex md:flex-row flex-col justify-between'>
              <h3 className='italic flex md:flex-row flex-col md:gap-2 gap-1'>
                ...
                <div className='md:w-[60%] border-t'>
                  <h5 className='mt-2'>I work on a variety of projects and constantly develop and expand my skills!</h5>
              ...
              <div className='w-full flex md:flex-row flex-col justify-between'>
                ...
                <div className='md:w-[60%] border-t'>
                  <h5 className='mt-2'>I spent a lot of my time at Princeton studying computer science before discovering how much I love design and am looking for new experiences to learn and apply </h5>
                  <div className='w-full py-16 justify-between'>
                  <ul className='flex flex-col gap-8'>
                    <div className='flex md:flex-row flex-col justify-between'>
                      <h4 className=''>2026-Present</h4>
                      <div className='md:w-[60%] w-full flex flex-col gap-2 mt-4 md:mt-0'>
                        <h3 className=''>Adobe Campus Ambassador</h3>
                    ...
                    <div className='flex md:flex-row flex-col justify-between'>
                      <h4 className=''>2025-Present</h4>
                      <div className='md:w-[60%] w-full flex flex-col gap-2 mt-4 md:mt-0'>
                        <h3 className=''>Lab Digital Designer and Technician</h3>
                        <ul className='list-disc pl-8'>
                    ...
                    <div className='flex md:flex-row flex-col justify-between'>
                      ...
                      <div className='md:w-[60%] w-full flex flex-col gap-2 mt-4 md:mt-0'>
                        <h3 className=''>E-Club Design Team</h3>
                        <ul className='list-disc pl-8'>
              ...
              <div className='w-full flex md:flex-row flex-col justify-between'>
                ...
                <div className='md:w-[60%] border-t'>
                  <h5 className='mt-2'>I use a variety of tools in my projects:</h5>
                  <div className='w-full py-16 flex md:flex-row flex-col gap-4'>
                    <div className='w-full flex flex-col'>
                      <h4 className='border-r border-l border-t py-2'>UI/UX</h4>
                    ...
                    <div className='w-full flex flex-col'>
                      <h4 className='border-r border-l border-t px-4 py-1'>Motion/Editing</h4>
                      <div className='border p-4 flex flex-col gap-2'>
                        <div className='flex gap-2'>
                    ...
                    <div className='w-full flex flex-col'>
                      <h4 className='border-r border-l border-t px-4 py-1'>Product</h4>
                      <div className='border p-4 flex flex-col gap-2'>
                        <div className='flex gap-2'>
                ...
                <div className='md:w-[60%] border-t'>
                  ...
                  <ul className='flex flex-col gap-8'>
                    <div className='flex justify-between'>
                      <h4 className=''>2026</h4>
                      <div className='w-[60%] flex flex-col'>
                        <h3 className=''>UCHV Short Movie Prize </h3>
                    ...
                    <div className='flex justify-between'>
                      ...
                      <div className='w-[60%] flex flex-col'>
                        <h3 className=''>Tower Club T-Shirt Design Winner </h3>
                        <ul className='list-disc'>
